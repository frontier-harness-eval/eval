...
| Purpose | Command |
| --- | --- |
| Create a clean runtime | `runta run --name demo --cpus 4 --memory 8192 --disk-size-gib 50` |
...
which is too small for the eval environment, so pass 50. Restoring a checkpoint always
